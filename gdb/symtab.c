  ...
  if (gdbarch_osabi (current_inferior ()->arch ()) == GDB_OSABI_WINDOWS)
    {
      ...
      msym = lookup_minimal_symbol (pspace, "main", NULL, NULL);
      if (msym.minsym != NULL)
	{
      ...
      msym = lookup_minimal_symbol (pspace, "wmain", NULL, NULL);
      if (msym.minsym != NULL)
	{
      ...
      msym = lookup_minimal_symbol (pspace, "mainCRTStartup", NULL, NULL);
      if (msym.minsym != NULL)
	{
